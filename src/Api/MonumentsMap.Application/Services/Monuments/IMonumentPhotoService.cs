...
{
    public interface IMonumentPhotoService: ILocalizedRestService<LocalizedMonumentPhotoDto, EditableLocalizedMonumentPhotoDto, MonumentPhotoRequestFilterDto>
    {
